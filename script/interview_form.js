async function handleInterviewFormSubmit() {
    const testForm = document.getElementById('interview-form');
    testForm.addEventListener('submit', async (event) => {
      event.preventDefault();
              // Validate the form data
        const nationalCodeInput = document.getElementById('nationalcode-visit-id');
